...
class SalesController extends Controller {
    ...
    function index(){
        ...
        $sql = "SELECT DISTINCT  f_industrytype FROM t_memberlibary WHERE f_industrytype<>''";
        $result = M('memberlibary')->query($sql);
...
//        $this->display();
    ...
    function modi(){
        set_theme();
        $id = I('id');
        $result = M('memberlibary')->where('f_indexid='.$id)->find();
