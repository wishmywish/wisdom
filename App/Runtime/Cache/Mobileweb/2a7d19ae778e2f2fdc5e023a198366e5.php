...
<head>
    ...
    <style type="text/css">
        ...
        * {
        ...
        .content .btn02{
            background-image:url(/wisdom/Public/Mobileweb/Default/images/jf_btn3.png);
            background-repeat:no-repeat;
            background-size: 100% 100%;
            font-size: 16px;
            color: #fff;
    ...
    <script>
        //剩余的次数
//        var cc="<?php echo ($cc); ?>";
        var times=parseInt("<?php echo ($all_infomation["times"]); ?>");
        var appid="<?php echo ($data["appid"]); ?>";
        var timestamp="<?php echo ($data["timestamp"]); ?>";
        var nonceStr="<?php echo ($data["nonceStr"]); ?>";
        var signature="<?php echo ($data["signature"]); ?>";
//        alert("---");
//        alert(appid+"**"+timestamp+"**"+nonceStr+"**"+signature+"**");
        //对页面进行数字签名验证
        set_share_config(appid,timestamp,nonceStr,signature);
    </script>
    <script type="text/javascript" src="/wisdom/Public/Mobileweb/Default/js/app_game.js"></script>
   <script>
       wx.ready(function() {
           wx.showMenuItems({
...
//           wx.hideMenuItems({
//               menuList: ["share:qq","share:weiboApp","share:facebook","share:QZone","openWithQQBrowser","openWithSafari"] // 要隐藏的菜单项，只能隐藏“传播类”和“保护类”按钮，所有menu项见附录3
//           });

           var f_mypcid=$("#f_mypcid").val();
           //监听获取“分享给朋友”按钮点击状态及自定义分享内容接口
           wx.onMenuShareAppMessage({
               title:"特斯拉电动车5元众筹，先抢红包就不用花钱啦",
               desc: "<?php echo ($f_wechatnice); ?>:我和特斯拉电动车的距离就差你了，快来帮帮我，我也会帮你的。", // 分享描述
...
//            获取“分享到朋友圈”按钮点击状态及自定义分享内容接口
           wx.onMenuShareTimeline({
               title: '特斯拉电动车5元众筹，先抢红包就不用花钱啦', // 分享标题
               desc: "<?php echo ($f_wechatnice); ?>:我和特斯拉电动车的距离就差你了，快来帮帮我，我也会帮你的。", // 分享描述
               link:"<?php echo ($shareurl); ?>", // 分享链接
               imgUrl:"<?php  echo $shareimg;?>", // 分享图标
               success: function () {
...
<div data-role="page">
    <div role="main" class="ui-content" style="padding: 0">
        <div id="mcover" onclick="document.getElementById('mcover').style.display='';" style="display:none;">
            <img src="/wisdom/Public/Mobileweb/Default/images/guide.png" />
        </div>
        ...
        <div class="content">
            <div class="box">
                ...
                <p class="djs">
                    ...
                    <span style="display: none" id="cc"><?php echo ($cc); ?></span>
                </p>
                ...
                <p class="btn" id="start" onclick="start()">
                    ...
                    <span class="btn0" >开始</span><span class="btn1" id="times">(剩余<?php echo ($all_infomation["times"]); ?>次)</span>
                </p>
                <p class="btn">
                    <img src="/wisdom/Public/Mobileweb/Default/images/game_btn1.png" style="width: 90%;margin: 0 5%">
                    <span class="btn0 yq" onclick="document.getElementById('mcover').style.display='block';">请好友帮忙</span>
                    <!--<span class="btn0 yq"  onclick="friend_help()">请好友帮忙</span>-->
                </p>

                <p class="btn">
                    <img src="/wisdom/Public/Mobileweb/Default/images/game_btn2.png" style="width: 90%;margin: 0 5%">
                    <span class="btn2">我的红包</span><span class="btn3" id="money"><?php echo ($all_infomation["my_total_gold"]); ?>元</span>
                </p>
                <!--<p style="font-size: 12px;">注：邀请6个好友帮你抢红包即可增加一次游戏机会</p>-->
                <p class="rules"><a  href="javascript:void(0)" onclick="showrule()">？游戏规则</a></p>
                <input type="hidden" value="<?php echo ($f_wechatid); ?>" id="f_wechatid"/>
                <input type="hidden" value="<?php echo ($f_wechatnice); ?>" id="f_wechatnice">
                <input type="hidden" value="<?php echo ($f_mypcid); ?>" id="f_mypcid">
            </div>
            ...
            <div class="box" >
                ...
                <p style="padding: 12% 3%; color: #2C506C; font-weight: bold; font-size: 14px;">品质商品，火热众筹，有红包就不用花钱啦。点击立即兑换，下载登入小宝招商APP，参与兑换。</p>
                <div class="proList">
                    <div class="prolists">
            ...
            <div class="box" >
                ...
                <p class="sort">
                      <!--有<span>10000</span>位好友帮我抢到了<span>2000.00</span>元红包-->
                      有<span><?php echo ($all_infomation["count_friend"]); ?></span>位好友帮我抢到了<span><?php echo ($all_infomation["total_gold"]); ?></span>元红包
                 </p>
                <ul class="sortList">
                    <?php if(is_array($all_infomation["all_list"])): $i = 0; $__LIST__ = $all_infomation["all_list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($vo["f_hepcid"] != '0'): ?><li><?php echo ($vo["helpnice"]); ?>帮我抢了<span style="float: right;"><?php echo ($vo["f_goldcoin"]); ?>元</span></li><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                </ul>
            </div>
        </div>
