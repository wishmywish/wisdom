...
<head lang="en">
    ...
    <style>
        ...
        .rg{float:right;}
        /*主体*/
        .main{overflow: hidden;width: 100%;  background: #f9f9f9; }
...
<div class="main">
    <div style="float: left;  margin: 20px 30px 0 30px;">
        是否立即下达该任务。如果下达，任务将自动分配给相应的参与人员，任务将不能再被编辑，也可以取消，后期再任务列表中进行编辑和下达。
    </div>
    <div style="text-align: right;width: 100%;float: left;">
        <button class="buts" >下达</button>
