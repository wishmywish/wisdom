...
<div style="display: none;"><script src="http://s11.cnzz.com/z_stat.php?id=1256375228&web_id=1256375228" language="JavaScript"></script></div>
    ...
    <script>
        ...
        /*初始化右侧选择数据*/
        function initCheck() {
            var hidcusTrade = '<?php echo ($hidcusTrade); ?>';
            if (hidcusTrade == "") {
                return;
            }
            var ids = hidcusTrade.split(",");
        ...
        function doSubmit() {
            ...
            // 将部门名设定到父画面
            parent.$("#cusTrade").val(cusTrade);
            // 将部门ID设定到父画面
            parent.$("#hidcusTrade").val(hidcusTrade);
