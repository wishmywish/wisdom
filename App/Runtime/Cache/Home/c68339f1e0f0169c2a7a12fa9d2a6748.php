            ...
            <div class="contentListAdd">
                ...
                <div class="lineTop">
                    ...
                    <select name="countryId" id="countryId" onchange="changeCountry(this.value);">
                        <option value=""></option>
                        <?php if(!empty($countryList["list"])): if(is_array($countryList["list"])): $i = 0; $__LIST__ = $countryList["list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$countryList): $mod = ($i % 2 );++$i;?><option value="<?php echo ($countryList["countryId"]); ?>"><?php echo ($countryList["countryName"]); ?></option><?php endforeach; endif; else: echo "" ;endif; endif; ?>
                    </select>
                ...
                <div class="lineTop">
                    ...
                    <input id="x" name="x" style="width: 136px;" type="text" onclick="showMap()">
                    <input id="y" name="y" style="width: 136px;" type="text" onclick="showMap()">
                </div>
                <div id="allmap"></div>
                <div class="lineTop">
                ...
                if(data.error_code == "success") {
                    if (!("list" in data)) {
                        ...
                        $.each(data.list, function(k, v) {
                            content += "<option value='"+ v.provinceId +"' id='province"+ v.provinceId+"' >"+ v.provinceName +"</option>";
                        });
            ...
            $.post("<?php echo U('Office/getCityList');?>", {'provinceId':provinceID}, function(data) {
                if(data.error_code == "success") {
                    if (!("list" in data)) {
                        ...
                        content = "<option value=''></option>";
                        $.each(data.list, function(k, v) {
                            content += "<option value='"+ v.cityId +"' id='city"+ v.cityId +"' >"+ v.cityName +"</option>";
                        });
                        $("#cityId").html(content);
                    }
                } else{
