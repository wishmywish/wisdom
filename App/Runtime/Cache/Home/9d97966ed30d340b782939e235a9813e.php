        ...
        <div class="head">
            <div class="head_center">
                ...
                <div class="personal_info">
                    <div  style="width:100%;"><div class="pro_img"><img style="height: 35px;" src="<?php echo ($headlogo); ?>"></div><div><?php echo empty(cookie("trueName"))?cookie("mobile"):cookie("trueName"); ?><b class="caret"></b></div></div>
    ...
    <div class="notice_center">
        ...
        <div class="notice_list">
            ...
            <div class="contentListAdd">
                <div class="lineTop">
                    <span>栏目名称</span>
                    <input id="boardName" style="width: 280px;" type="text" value="<?php echo ($noticeBoard["boardName"]); ?>">
                </div>
                <div class="lineTop">
                    <span>公告内容</span>
                    <textarea style="width: 600px;height: 220px;" id="boardDesc"><?php echo ($noticeBoard["boardDesc"]); ?></textarea>
                </div>
                <div class="lineTop">
                    <span>栏目负责人</span>
                    <textarea style="width: 590px;height: 80px;padding: 5px;" id="userNames" readonly="readonly"><?php echo ($noticeBoard["maintainerStr"]); ?></textarea>
                    <div style="padding-left: 15px;color: #898989;cursor: pointer;" class="fa fa-plus-square fa-lg" onclick="selectUsers();"></div>
                </div>
            </div>
            <input type="hidden" id="userIds" value="<?php echo ($noticeBoard["maintainer"]); ?>">
            <input type="hidden" id="boardId" value="<?php echo ($noticeBoard["boardId"]); ?>">
...
<script>
    ...
    function doSubmit() {
        ...
        $.post("<?php echo U('Office/addorEditNoticeBoard');?>", {'boardName':boardName, 'maintainer':maintainer, 'boardDesc':boardDesc, 'boardId':boardId}, function(data) {
            layer.close(loadIdx);
