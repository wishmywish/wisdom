...
<div class="main">
    <ul>
        ...
        <li><input type="text" id="customer" value="<?php echo ($_GET['cusName']); ?>" cusId="<?php echo ($_GET['cusId']); ?>" disabled="true" /></li>
    </ul>
    <ul>
        <li class="fll"><span>*</span>合同标题</li>
        <li><input type="text" id="title" style="width: 500px;text-overflow: ellipsis;white-space: nowrap;"/></li>
    </ul>
    <ul>
        <li class="fll"><span>*</span>合同编号</li>
        <li><input type="text" id="contractCode" style="text-overflow: ellipsis;white-space: nowrap;"/></li>
    </ul>
    <ul>
    ...
    <ul>
        ...
        <li style="position: relative">
            <input type="text" id="SJ"  placeholder="从客户商机中选择"/>
            <span class="fa fa-search fa-lg" style="position: absolute;right: 10px;top: 10px;color: #ccc;"></span>
        </li>
    </ul>
    <ul>
        <li class="fll"><span>*</span>签约日期</li>
        <li> <input type="text" class="laydate-icon" id="signDate" style="width: 230px;"/></li>
    </ul>
    <ul>
        <li class="fll"><span>*</span>有效期</li>
        <li>
            <input id="startDate" class="laydate-icon" value="" placeholder="起始时间" style="width: 90px;height: 25px;">
            至
            <input id="endDate" class="laydate-icon" value="" placeholder="终止时间" style="width: 90px;height: 25px;">
        </li>
    </ul>
    <ul>
        <li class="fll"><span>*</span>签约金额</li>
        <li><input type="text" id="money"/></li>
    </ul>
    <ul>
...
<script>
    ...
    function do_save(){
        ...
        var linkman = $("#linkman").attr("linkman_ids"); //签约人id
        ...
        $.post("<?php echo U('Office/insertContract');?>", {"enterpriseId":cusId, "cusClientIds":cusClientIds, "contractCode":contractCode, "crmBiz":bizId, "contractSubject":title, "ASigner":linkman, "signDate":signDate, "startDate":startDate, "endDate":endDate, "money":money, "content":content }, function(data) {
