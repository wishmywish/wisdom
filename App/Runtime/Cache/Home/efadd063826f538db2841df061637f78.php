...
<head lang="en">
    ...
    <style>
        ...
        .list ul li{ float: left;width: 600px;margin-right: 7px;}
    ...
    <div class="list">
        <div class="content cur1">
            ...
            <ul class="fl">
             ...
             <?php if($travel_detail['processStatus'] == '2' and $travel_detai['curProcessNodeOrder'] > '1'): ?><ul class="fl">
                <li>
...
<script>
    ...
    function doSelectUser() {
        ...
        layer.open({
            ...
            content: "<?php echo U('Office/selectIndexTravelUser');?>" + "?processId=" + processId + "&processNodeId=" + processNodeId + "&comment=" + comment + "&operateType=3&page=" + page + "&busiType=4",
        });
    }
