...
<head lang="en">
    ...
    <style>
        ...
        .main ul{margin: 20px 0 0 10px;width: 100%;}
...
<div class="main">
            ...
            <ul class="fl">
                <li>
                    ...
                    <span class="fa fa-search fa-lg" style="position: absolute;left: 215px;top: 118px;color: #898989;"></span>
                    <span>关联商机</span>
                    <input style="width: 204px;height:30px;float: left;"  type="search" placeholder=" 请选择范围" class="link">
                    <span class="fa fa-search fa-lg" style="position: absolute;left: 526px;top: 118px;color: #898989;"></span>
                </li>
            ...
            <ul class="fl">
                ...
                <p style="float:right;margin: -15px 110px 0 0;width: 40px;"><i style="margin-right: 5px;cursor: pointer;" class="fa fa-plus-square"></i><i style="cursor: pointer;" class="fa fa-minus-square"></i></p>
