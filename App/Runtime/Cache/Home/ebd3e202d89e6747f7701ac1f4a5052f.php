...
<div class="main">
    ...
    <ul class="fl">
        <span style="margin-left: 17px;">审阅人</span>
        <input id="" name="reviewName" style="line-height: 25px;width:175px;padding-left: 15px;white-space:nowrap;overflow:hidden;text-overflow: ellipsis;background: #eeeeee;}" type="text" disabled="disabled" readonly="readonly" value="<?php echo ($work_report["list"]["viewPeople"]); ?>" >
    </ul>
    <ul style="float: right;margin-right: -313px;margin-top: -26px;">
        <span>&nbsp;&nbsp;&nbsp;&nbsp;审阅时间</span>
        <input id="" name="reviewTime" style="line-height: 25px;width:175px;padding-left: 15px;white-space:nowrap;overflow:hidden;text-overflow: ellipsis;background: #eeeeee;}" type="text" disabled="disabled"  readonly="readonly" value="<?php echo ($work_report["list"]["viewTime"]); ?>" >
    </ul>
    <ul class="fl">
        <div class="fj-but" style="margin-left: 15px;">
