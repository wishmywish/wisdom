            ...
            <div id="contentList">
                ...
                <div id="contentList2" class="index_from_text_task" style="display: none">
                    ...
                    <div style="margin-top: 24px;margin-bottom: 3px;">
                        ...
                        <ul>
                            <span>&nbsp;&nbsp;&nbsp;&nbsp;起始时间</span>
                            <input id="startdate" class="laydate-icon" value="" placeholder="起始时间" style="width: 155px;margin-right:28px;padding-left: 15px;height:25px;">
                            <span>终止时间</span>
                            <input id="enddate" class="laydate-icon" value="" placeholder="终止时间" style="width: 155px;padding-left: 15px;margin-right: 32px;height: 25px;">
                            <input type="checkbox">
                ...
                <div id="contentList3" class="index_from_text_task" style="display: none">
                    <div class="index_from_text">
                        <textarea name="" placeholder="请输入日志内容"></textarea>
                    </div>
                    <div style="margin: 24px 0 5px;">
                        <ul>
                            ...
                            <li style="margin-top:10px" >
                                <input type="radio" id="dailyRecord" name="record"  value="1"  checked="checked"/><span  style="margin-right:10px">日报</span>
                                <input type="radio" id="weeklyRecord"  name="record"  value="2" /><span  style="margin-right:10px">周报</span>
                                <input type="radio" id="monthlyRecord"  name="record"   value="3" /><span style="margin-right:10px">月报</span>
                            </li>
                        </ul>
                        <ul id="dailydate">
                            <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;日期</span>
                            <input id="date" class="laydate-icon" value="" placeholder="请选择日期" style="width: 155px;margin-right:28px;padding-left: 15px;height: 25px;">
                        </ul>
                        ...
                        <ul>
                            <span>&nbsp;&nbsp;&nbsp;&nbsp;发送到</span>
                            <input style="height: 25px;padding-left: 15px;" type="text" placeholder="+发送到">
                        </ul>
                    </div>
                ...
                <div id="contentList5" class="index_from_text_task" style="display: none">
                    ...
                    <div style="margin: 24px 0 5px;">
                        ...
                        <ul>
                            <span>&nbsp;&nbsp;&nbsp;起始时间</span>
                            <input id="startdate" class="laydate-icon" value="" placeholder="起始时间" style="height: 25px;width: 155px;margin-right:28px;padding-left: 15px;">
                            <span>终止时间</span>
                            <input id="enddate" class="laydate-icon" value="" placeholder="终止时间" style="height: 25px;width: 155px;padding-left: 15px;margin-right: 32px;">
                            <input type="checkbox">
                            <span style="text-align: center">&nbsp;&nbsp;全天</span>
                        </ul>
                        <ul>
                ...
                <div id="contentList6" class="index_from_text_task" style="display: none">
                    ...
                    <div style="margin: 24px 0 5px;">
                        ...
                        <ul>
                            <span>&nbsp;&nbsp;&nbsp;出发时间</span>
                            <input id="startdate" class="laydate-icon" value="" placeholder="出发时间" style="height: 25px;width: 155px;margin-right:28px;padding-left: 15px;">
                            <span>返回时间</span>
                            <input id="enddate" class="laydate-icon" value="" placeholder="返回时间" style="height: 25px;width: 155px;padding-left: 15px;margin-right: 32px;">
                        </ul>
                        <ul>
                            <span>&nbsp;&nbsp;&nbsp;审批人员</span>
                            <input style="height: 25px;padding-left: 15px;" type="search" placeholder="无"><span style="padding-left: 15px;color: #898989;cursor: pointer;" class="fa fa-plus-square fa-lg"></span>
