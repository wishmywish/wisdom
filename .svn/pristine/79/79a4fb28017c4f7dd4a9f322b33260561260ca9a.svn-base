...
/* global FusionCharts, echarts */
   ...
   $.post(APP+"/Api/Web/InvTargetstatistics","taskid="+taskid,function(v){
           Invpercent=v.Actinvestment/v.Invtarget;
           ...
           $("#paypect").html(v.actualpayment/v.collecttarget+"%");
           ...
           invquit+="<table border='1' style='border-collapse: collapse' class='map_table'><thead><tr><th>序号</th><th>区域</th><th>数量</th></tr></thead><tbody>";
           //展示招商排名前五的区域
