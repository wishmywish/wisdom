...
$('#c_set_submit').click(function () {
    ...
    var c_phone = $.trim($('#c_phone').val()); //固定电话
...
*/
    ...
    var fieldkey = "contactPerson|address|regCapital|state|companyName|industryId|contactMobile|phone|email|website|companyLegal|mainProduct|mainArea|turnOver|ageCount|employeeCount|salesCount|qualityManagDep|techDep|markDep|aftersaleDep";
    var fieldval = c_link+"|"+c_address+"|"+c_regCapital+"|4|"+c_name+"|"+c_business+"|"+c_phone+"|"+c_tel+"|"+c_email+"|"+c_websit+"|"+c_legal+"|"+c_products+"|"+c_area+"|"+c_year+"|"+c_dealer+"|"+c_staff+"|"+c_salesman+"|"+c_quality+"|"+c_technology+"|"+c_market+"|"+c_service;

    $.post(APP+"/Api/Api/inport","command=modiCompanyInfo&companyid="+companyId+"&fieldkey="+fieldkey+"&fieldval="+fieldval,function(data){
